...
def two_ai_game():
    ...
    while not game_is_over(my_board):
      ...
      result = minimax(my_board, True,4 , -float("Inf"), float("Inf"), evaluate_board_one)
      print( "X Turn\nX selected ", result[1])
      print(result[1])
      ...
      if not game_is_over(my_board):
        ...
        result = minimax(my_board, False, 4, -float("Inf"), float("Inf"), evaluate_board_two)
        print( "O Turn\nO selected ", result[1])
        print(result[1])
...
def gameloadingscreen():
    ...
    if redButton:
        playerasred(evaluate_board_two, depthnessNumber, speedNumber)
        new_board = make_board()
    elif yellowButton:
        playerasyellow(evaluate_board_two, depthnessNumber, speedNumber)
        new_board = make_board()
    elif aiButton:
        aigame(evaluate_board_two, evaluate_board_one, depthnessNumber, speedNumber)
        new_board = make_board()
